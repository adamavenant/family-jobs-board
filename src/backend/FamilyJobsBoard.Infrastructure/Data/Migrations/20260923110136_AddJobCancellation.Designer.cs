...
namespace FamilyJobsBoard.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260923110136_AddJobCancellation")]
    partial class AddJobCancellation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FamilyJobsBoard.Domain.Jobs.Job", b =>
                {
                    ...
                    b.Property<Guid?>("CancelledByMemberId")
                        .HasColumnType("uuid")
                        .HasColumnName("cancelled_by_member_id");
                    ...
                    b.HasIndex("CancelledByMemberId");
                    ...
                    b.ToTable("jobs", null, t =>
                        {
                            t.HasCheckConstraint("ck_jobs_cancellation_details", "(status = 'Cancelled' AND cancelled_by_member_id IS NOT NULL AND cancelled_at_utc IS NOT NULL) OR (status <> 'Cancelled' AND cancelled_by_member_id IS NULL AND cancelled_at_utc IS NULL AND cancellation_reason IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("FamilyJobsBoard.Domain.PointAdjustments.PointAdjustment", b =>
                {
                    ...
                    b.Property<Guid>("AdjustedByMemberId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AdjustedByMemberId");

                    b.HasIndex("RequestId")
                        .IsUnique()
                        .HasDatabaseName("ux_point_adjustments_request_id");

                    b.HasIndex("ChildId", "AdjustedAtUtc");

                    b.ToTable("point_adjustments", null, t =>
                        {
                            t.HasCheckConstraint("ck_point_adjustments_amount", "amount <> 0");

                            t.HasCheckConstraint("ck_point_adjustments_reason", "length(btrim(reason)) > 0");
                        });
                });
            ...
            modelBuilder.Entity("FamilyJobsBoard.Domain.Points.PointsLedgerEntry", b =>
                {
                    ...
                    b.Property<Guid?>("PointAdjustmentId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FamilyJobsBoard.Domain.Jobs.Job", b =>
                {
                    b.HasOne("FamilyJobsBoard.Domain.Households.HouseholdMember", null)
                        .WithMany()
                        .HasForeignKey("CancelledByMemberId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FamilyJobsBoard.Domain.PointAdjustments.PointAdjustment", b =>
                {
                    b.HasOne("FamilyJobsBoard.Domain.Households.HouseholdMember", null)
                        .WithMany()
                        .HasForeignKey("AdjustedByMemberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
